...
import { AssignSlotService } from './application/assign-slot.service.js';
...
export function createSchedulingService(
  ...
  return {
    assignSlot: new AssignSlotService({ districtReader, venueReader, eventBus }),
  };
}
...
export type { SchedulingServiceConfig, SchedulingSecurityConfig } from './config.js';
