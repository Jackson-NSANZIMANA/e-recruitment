// ══════════════════════════════════════════════════════════════════
// edge-gateway — Upstream HTTP gateway adapter
//
// Implements the UpstreamGateway port using HTTP/fetch. This is the adapter
// layer: concrete HTTP implementation behind an abstract interface.
//
...
/**
 * HTTP implementation of UpstreamGateway port.
 * Calls backend microservices via HTTP/fetch.
 */
